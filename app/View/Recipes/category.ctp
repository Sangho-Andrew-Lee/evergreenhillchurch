...
<div class="banner padd">
    <div class="container">
        ...
        <!-- Heading -->
        <h2 class="white"><?php echo $categories[$category]; ?></h2>
        <ol class="breadcrumb">
            <li><?php echo $this->Html->link('Home', '/'); ?></li>
            <li><?php echo $this->Html->link('All Recipes', array('controller' => 'recipes', 'action' => 'index')); ?></li>
            <li class="active">Category of <?php echo $categories[$category]; ?></li>
        </ol>
