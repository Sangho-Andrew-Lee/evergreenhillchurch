        ...
        <ul>	<!-- SLIDE  -->
            <li data-transition="fade" data-slotamount="7" data-masterspeed="1500" >
                ...
                <div class="tp-caption customin customout"
                     ...
                     data-endspeed="300"
                     style="z-index: 6">
                     <?php echo $this->Html->image('evergreenhill_youthchior1.jpg', array('class' => 'slide-img img-responsive', 'alt' => '')); ?>
                </div>
                <!-- LAYER NR. 3.2 -->
                <div class="tp-caption customin customout"
                     ...
                     data-endspeed="300"
                     style="z-index: 7">
                     <?php echo $this->Html->image('evergreenhill_churchsermon1.jpg', array('class' => 'slide-img img-responsive', 'alt' => '')); ?>
                </div>
                <!-- LAYER NR. 3.3 -->
                <div class="tp-caption customin customout"
                     ...
                     data-endspeed="300"
                     style="z-index: 8">
                     <?php echo $this->Html->image('evergreenhill_chior2.jpg', array('class' => 'slide-img img-responsive', 'alt' => '')); ?>
                </div>
            </li>
            <li data-transition="zoomin" data-slotamount="6" data-masterspeed="400" >
                ...
                <div class="tp-caption sft"
                     ...
                     data-endeasing="Power4.easeIn"
                     style="z-index: 10">
                    <span class="price-tag br-white">30%<br />Off</span>
                </div>
                <!-- LAYER NR. 3 -->
                <div class="tp-caption finewide_verysmall_white_mw paragraph customin customout tp-resizeme"
                    ...
                    Lorem ipsum dolor sit amet, consetetur<br/>  sadipscing elitr, sed diam nonumy<br/>  eirmod tempor invidunt ut labore et<br/>  dolore magna aliquyam erat, sed diam <br/> voluptua. At vero eos et accusam.
                </div>
                <!-- LAYER NR. 4 -->
                <div class="tp-caption sfb"
                    ...
                    <a class="btn btn-success hidden-xs" href="#">Purchase Now</a>
                </div>
            </li>
            <li data-transition="slidehorizontal" data-slotamount="1" data-masterspeed="600" >
                <!-- MAIN IMAGE -->
                <?php echo $this->Html->image('slider/transparent.png', array('style' => 'background-color:#fea501', 'alt' => '', 'data-bgfit' => 'cover', 'data-bgposition' => 'center bottom', 'data-bgrepeat' => 'no-repeat')); ?>
                <!-- LAYERS NR. 1 -->
                <div class="tp-caption lfl"
                     ...
                     data-captionhidden="off">
                     <?php echo $this->Html->image('evergreenhill_youthretreat3.jpg', array('class' => 'img-responsive', 'alt' => ''));?>
                </div>
                <!-- LAYERS NR. 2 -->
                ...
                <div class="tp-caption finewide_verysmall_white_mw white customin customout tp-resizeme text-right paragraph"
                     ...
                     data-endspeed="300"
                     style="z-index: 10; max-width: auto; max-height: auto; white-space: nowrap;">
                     Lorem ipsum dolor sit amet, consetetur  sadipscing elitr,<br/> nonumy voluptu ansetetur  sadipscing elit. <br/> sed diam quisquam est nonumy voluptu vero eos et.
                </div>
            </li>
            <li data-transition="cube" data-slotamount="7" data-masterspeed="600" >
                ...
                <div class="tp-caption skewfromright medium_text text-right paragraph"
                     ...
                     data-captionhidden="off">
                    At vero eos etntium accu amet, adipisicing samus iusto<br />praese  delen itieos etconsectetur atque corrupti<br />praese etntiumder delen itierrupti.
                </div>
                <!-- LAYERS NR. 6 // -->
